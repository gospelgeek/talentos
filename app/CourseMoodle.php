...
class CourseMoodle extends Model
{
    ...
    public static function asistencias_virtuales($id_group,$id_moodle,$fecha_inicial,$fecha_final){
        if($fecha_final != null && $fecha_final != null){
            $asistencias = DB::select("select 
                            course_moodles.id,course_moodles.fullname,course_moodles.docente_name,COUNT(*) as Total 
    ...
    public static function asignaturas($grupo, $moodle){
        $data = DB::select("
                    select course_moodles.id,course_moodles.course_id,course_moodles.fullname,course_moodles.docente_name,course_items.category_name,students_grades.grade
