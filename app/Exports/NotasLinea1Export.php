    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->mergeCells('A2:EM2');
                ...
                $event->sheet->getDelegate()->mergeCells('DM3:DU3');
                $event->sheet->getDelegate()->mergeCells('DV3:ED3');
                $event->sheet->getDelegate()->mergeCells('EE3:EM3');
                
                $event->sheet->getDelegate()->getStyle('A4:EM4')
                        ->getFill()
                ...
                $event->sheet->getDelegate()->getStyle('A3:EM3')
                    ->getAlignment()
                    ->setHorizontal(\PhpOffice\PhpSpreadsheet\Style\Alignment::HORIZONTAL_CENTER);
            },
        ];
