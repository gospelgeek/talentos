...
class NotasLinea2Export implements FromArray, WithHeadings, ShouldAutoSize, WithEvents
{
    ...
    public function headings(): array
    {
        return [
            ...
            ['DATOS PERSONALES','','','','','','','', 'BIOLOGIA','','','', 'ARTES: CONOCIMIENTO EN ACCION','','','', 'DEPORTE Y SALUD INTEGRAL','','','', 'DIALOGO DE SABERES Y ORIENTACION VOCACIONAL','','','', 'CONSTITUCIÓN','','','', 'FISICA','','','', 'GEOGRAFIA','','','', 'HISTORIA','','','', 'INGLES','','','', 'LECTURA CRITICA','','','', 'MATEMATICAS','','','', 'QUIMICA','','','', 'TECNOLOGIA DE LA INFORMACION Y LAS COMUNICACIONES'],
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class    => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->mergeCells('A2:BH2');
                ...
                $event->sheet->getDelegate()->getStyle('A4:BH4')
                        ->getFill()
