    ...
    public function Grupos_Asignatura($id){
        ...
        $grupos->map(function($grupo,$index){
            ...
            if($course_moodle){
                ...
                $promedio_seguimientos = StudentsGrade::select(DB::raw('CAST(AVG(grade) AS DECIMAL(10,2)) as total_curso'))->where('item_id',$seguimientos? $seguimientos->item_id : null)->get();
                ...
                $promedio_autoevaluacion = StudentsGrade::select(DB::raw('CAST(AVG(grade) AS DECIMAL(10,2)) as total_curso'))->where('item_id',$autoevaluacion? $autoevaluacion->item_id : null)->get();
