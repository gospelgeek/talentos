...
class perfilEstudiante extends Model
{
    ...
    public static function estudiantes(){
        $data = DB::select("student_profile.id, select student_profile.name, student_profile.lastname, student_profile.document_number, student_profile.student_code, student_profile.email, student_profile.cellphone, 
