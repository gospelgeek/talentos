...
<script>
    ...
    function editarModal(documento, _url, Total, LC, MT, CS, CN, IN, _prueba) {
        ...
        _actualizar.addEventListener('click', (e) => {
            ...
            if (_url !== url.value) cambios[0] = true
            if (parseInt(Total) !== puntaje.value) cambios[1] = true
            if (parseInt(LC) !== lecturaC.value) cambios[2] = true
            if (parseInt(MT) !== mate.value) cambios[3] = true
            if (parseInt(CS) !== cienS.value) cambios[4] = true
            if (parseInt(CN) !== cienN.value) cambios[5] = true
            if (parseInt(IN) !== ingles.value) cambios[6] = true
            */
