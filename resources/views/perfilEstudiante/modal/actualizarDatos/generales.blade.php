              ...
              <div class="container-fluid">
                {!!Form::model($verDatosPerfil,['route'=>['updatedatosgenerales',$verDatosPerfil->id], 'method'=>'PUT'])!!}
                  ...
                  <div class="row">
                      ...
                      {!!Form::select('ciudad_nacimiento',$ciudad_nacimiento, $verDatosPerfil->birthcity->id,['id'=>'ciudadNacimiento','class'=>'form-control','required','placeholder'=>'Ciudad nacimiento'])!!}  
                      </div>
                      <div class="col-xs-12 col-sm-4 form-group {{$errors->has('body') ? 'has-errors' : ''}}">
