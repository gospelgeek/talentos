			...
			<div class="form-group">
    			<div class="row">
					...
					<div class="col-xs-2 col-md-6">
						<div class="row">
							<div class="col-xs-12 col-md-12">
								<input readonly class="form-control" type="text" name="graduate_schooling" id="graduate_schooling" value="{{ old('graduate_schooling', $verDatosPerfil->previousacademicdata ? $verDatosPerfil->previousacademicdata->graduate_schooling : null) }}">
							</div>
						</div>                	
            		</div>
           		</div>
